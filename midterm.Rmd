...
```{r ans62}
# invoiceList 
(invoiceList[[1]]=="America/New_York") -> nyLogical
(invoiceList[[1]]=="Asia/Taipei") -> tpLogical
invoiceList[[3]][nyLogical] <- with_tz(ymd_hms(invoiceList[[2]][nyLogical], tz="America/New_York"),tzone="UTC")
invoiceList[[3]][tpLogical] <- with_tz(ymd_hms(invoiceList[[2]][tpLogical], tz="Asia/Taipei"),tzone="UTC")
invoiceList 
```
